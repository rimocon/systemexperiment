...
void  calibrationColorSensorWhite()
{
  ...
  Serial.println(dataR_max);
  Serial.println(dataG_max);
  Serial.println(dataB_max);
...
void  calibrationColorSensorBlack()
{
  ...
  Serial.println(dataR_min);
  Serial.println(dataG_min);
  Serial.println(dataB_min);
...
void readRGB()
{
  ...
  if( green_G < 0 ) red_G = 0;  
  if( green_G > 255 ) red_G = 255;
  if( blue_G < 0 ) red_G = 0;  
  if( blue_G > 255 ) red_G = 255;
}
