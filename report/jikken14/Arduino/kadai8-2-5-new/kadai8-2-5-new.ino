...
int Nearest_Neighbor() {
  ...
  if (color == 0) Serial.println("0");
  else if (color == 1) Serial.println("1");
  else if (color == 2 || color == 3) Serial.println("8");
  else if (color == 4) Serial.println("2");
  else if (color == 5) Serial.println("3");
  else if (color == 6) Serial.println("4");
  else if (color == 7) Serial.println("5");
  else if (color == 8) Serial.println("6");
  else if (color == 9) Serial.println("7");
