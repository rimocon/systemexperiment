...
void serialEvent(Serial myPort) {
  ...
  if (myString != null){
    ...
    if (data.length >1){
      ...
      // キャリブレーションあり
      Red = map(data[0], 7680, 35328, 0, 255); //下線部をシリアルモニタの最大値に変更
      Green = map(data[1], 16904, 60424, 0, 255); //ここに Green の処理を入れる
      Blue = map(data[2], 11520, 44032, 0, 255);; //ここに Blue の処理を入れる
      // max 35328,60424,44032
      // min 7680,16904,11520
